...
public:
	...
	virtual i32 GetMuchaCAConfig(char* a1) {
		memset(a1, 0, 0x13C);
		strncpy_s(a1, 4, "1", 3); // wm6 or w6r or w6w i guess?
		strncpy_s(a1 + 4, 0x10, "ALL.NET", 0xF);
		strncpy_s(a1 + 20, 8, "SBWJ", 7);
		strncpy_s(a1 + 28, 8, "9.00", 7);
		strncpy_s(a1 + 36, 8, "WM61", 7);  // ignored by game
		strncpy_s(a1 + 44, 8, "03.04", 7); // GAME VERSION
		strncpy_s(a1 + 52, 4, "0", 3); // BOARD TYPE
		strncpy_s(a1 + 56, 4, "WM6", 3); // BOARD ID
		return 0;
	}
